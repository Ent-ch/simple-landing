...
exports.SlideBlock = exports.Modal = exports.fetchInit = exports.helpPath = exports.catsPath = undefined;
...
var catsPath = exports.catsPath = '/#/Services';
var helpPath = exports.helpPath = '/#/Help';

var fetchInit = exports.fetchInit = {
    method: 'GET',
    headers: {
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'close', type: 'button', 'data-dismiss': 'modal', onClick: handleClose },
                        _react2.default.createElement(
                            'span',
                            { 'aria-hidden': 'true' },
                            '\xD7'
                    ...
                    _react2.default.createElement('h4', { className: 'modal-title', id: 'myModalLabel' })
                ),
                _react2.default.createElement(
                    'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-default', type: 'button', 'data-dismiss': 'modal', onClick: handleClose },
                        'Close'
                    )
                )
            )
...
var SlideBlock = exports.SlideBlock = function (_React$Component) {
    _inherits(SlideBlock, _React$Component);

    function SlideBlock() {
        _classCallCheck(this, SlideBlock);

        return _possibleConstructorReturn(this, (SlideBlock.__proto__ || Object.getPrototypeOf(SlideBlock)).apply(this, arguments));
    }

    _createClass(SlideBlock, [{
        key: 'render',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'ul',
                                { className: 'nav navbar-right panel_toolbox', style: { minWidth: '20px' } },
                                _react2.default.createElement(
                                    'li',
                                    null,
                                    _react2.default.createElement(
...
var _freeSolidSvgIcons = __webpack_require__(91);

__webpack_require__(92);

__webpack_require__(93);

var _mdRender = __webpack_require__(94);
...
var mainPage = function mainPage() {
    return _react2.default.createElement(
        App,
        { mainChapter: 'home' },
        _react2.default.createElement(_mdRender2.default, { chapter: 'home' })
    );
};

var documentsPage = function documentsPage(_ref) {
    var _ref$match$params$cha = _ref.match.params.chapter,
        chapter = _ref$match$params$cha === undefined ? 'documentation' : _ref$match$params$cha;

    return _react2.default.createElement(
        App,
        { mainChapter: chapter },
        _react2.default.createElement(_mdRender2.default, { chapter: chapter.toLowerCase() })
    );
};
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                classNameName = _props.classNameName,
...
var _jqLite = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fortawesome_fontawesome_svg_core__ = __webpack_require__(90);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(25), __webpack_require__(1)))
...
var _remarkable = __webpack_require__(41);
...
var SlideDoc = function (_React$Component) {
    _inherits(SlideDoc, _React$Component);

    function SlideDoc(props) {
        _classCallCheck(this, SlideDoc);

        var _this = _possibleConstructorReturn(this, (SlideDoc.__proto__ || Object.getPrototypeOf(SlideDoc)).call(this, props));

        _this.getData = function (chapter) {
            var docsDir = 'https://raw.githubusercontent.com/bNesisDeveloper/bNesis/master/Landing/';

            fetch('' + docsDir + chapter + '.md').then(function (data) {
                var text = data.text();
